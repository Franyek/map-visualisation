...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        drawLink: function (id, xa, ya, xb, yb, elemOptions) {
            ...
            // Solution for equation dist(cd) = sqrt((xd - xc)2 + (yd - yc)2)
            // dist(c,d)2 = (xd - xc)2 + (yd - yc)2
            // We assume that dist(c,d) = dist(a,b)
            // so : (xd - xc)2 + (yd - yc)2 - dist(a,b)2 = 0
            // With the factor : (xd - xc)2 + (yd - yc)2 - (factor*dist(a,b))2 = 0
            // (xd - xc)2 + (acd*xd + bcd - yc)2 - (factor*dist(a,b))2 = 0
            var a = 1 + acd * acd;
